...
local function _15_()
  ...
  vim.keymap.set("n", "<leader>fs", _18_)
  local function _19_()
    return mini_extra.pickers.lsp({scope = "references"})
  end
  return vim.keymap.set("n", "<leader>fr", _19_)
end
local function _20_()
...
lazy.setup({{url = "https://github.com/justinmk/vim-gtfo", config = _2_}, {url = "https://github.com/tyru/open-browser.vim"}, {url = "https://github.com/lewis6991/fileline.nvim"}, {url = "https://github.com/lewis6991/gitsigns.nvim", config = _3_}, {url = "https://github.com/tpope/vim-fugitive", config = _9_}, {url = "https://github.com/tpope/vim-rhubarb"}, {url = "https://github.com/mattn/vim-gotmpl"}, {url = "https://github.com/fladson/vim-kitty"}, {url = "https://github.com/NoahTheDuke/vim-just"}, {url = "https://github.com/raimon49/requirements.txt.vim"}, {url = "https://github.com/jaawerth/fennel.vim"}, {url = "https://github.com/janet-lang/janet.vim"}, {url = "https://github.com/Olical/nfnl"}, {url = "https://github.com/Olical/conjure", branch = "develop", config = _10_}, {url = "https://github.com/gpanders/nvim-parinfer"}, {url = "https://github.com/vim-test/vim-test", dependencies = {{url = "https://github.com/tpope/vim-dispatch"}}, config = _11_}, {url = "https://github.com/neovim/nvim-lspconfig"}, {url = "https://github.com/b0o/SchemaStore.nvim"}, {url = "https://github.com/stevearc/conform.nvim", opts = {formatters_by_ft = {proto = {"buf"}, just = {"just"}, fish = {"fish_indent"}, json = {"prettier"}, typescriptreact = {"prettier"}, sql = {"pg_format"}}, format_on_save = {timeout_ms = 500, lsp_fallback = true}}}, {url = "https://github.com/mfussenegger/nvim-lint", config = _12_}, {url = "https://github.com/williamboman/mason.nvim", config = true, build = ":MasonUpdate"}, {url = "https://github.com/williamboman/mason-lspconfig.nvim", config = true}, {url = "https://github.com/nvim-treesitter/nvim-treesitter", build = ":TSUpdate", config = _14_}, {url = "https://github.com/echasnovski/mini.nvim", config = _15_}, {url = "https://github.com/tpope/vim-eunuch"}, {url = "https://github.com/andymass/vim-matchup", config = _20_}, {url = "https://github.com/ggandor/leap.nvim", dependencies = {{url = "https://github.com/tpope/vim-repeat"}}, config = _21_}, {url = "https://github.com/tpope/vim-abolish"}, {url = "https://github.com/rktjmp/paperplanes.nvim"}, {url = "https://github.com/rktjmp/lush.nvim"}, {url = "https://git.sr.ht/~p00f/alabaster.nvim", lazy = true, priority = 1000, config = _22_}, {url = "https://github.com/stefanvanburen/rams", lazy = true, priority = 1000, dependencies = {{url = "https://github.com/stefanvanburen/rams"}}, config = _23_}, {url = "https://github.com/mcchrish/zenbones.nvim", lazy = true, priority = 1000, config = _24_}, {url = "https://github.com/rose-pine/neovim", name = "rose-pine", lazy = true, priority = 1000, config = _25_}}, {install = {colorscheme = {"randomhue", "zenwritten", "rams", "alabaster", "rose-pine"}}})
vim.api.nvim_create_autocmd("VimResized", {command = ":wincmd ="})
local function _26_()
  return vim.highlight.on_yank()
end
vim.api.nvim_create_autocmd("TextYankPost", {callback = _26_})
...
do
  ...
  for filetype, settings in pairs(filetype_settings) do
    ...
    vim.api.nvim_create_autocmd("FileType", {group = aufiletypes, pattern = filetype, callback = _27_})
  end
  local function _28_()
    return vim.api.nvim_set_option_value("filetype", "markdown", {scope = "local"})
  end
  vim.api.nvim_create_autocmd({"BufNewFile", "BufRead"}, {group = aufiletypes, pattern = "*.mdx", callback = _28_})
  local function _29_()
    return vim.api.nvim_set_option_value("filetype", "starlark", {scope = "local"})
  end
  vim.api.nvim_create_autocmd({"BufNewFile", "BufRead"}, {group = aufiletypes, pattern = "*.star", callback = _29_})
  local function _30_()
...
map("n", "<leader>cl", _45_)
local function _46_()
  return vim.cmd({cmd = "split"})
end
map("n", "<leader>ss", _46_)
local function _47_()
