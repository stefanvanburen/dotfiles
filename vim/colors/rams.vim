...
" License:      TODO
" Last Updated: Mon Apr 27 09:12:46 2020
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#394759', '#ff3100', '#ff3100', '#ff3100',
          \ '#ff3100', '#ff3100', '#ff3100', '#ebebeb', '#394759', '#ff3100',
    ...
    if get(g:, 'rams_transp_bg', 0) && !has('gui_running')
    ...
    hi IncSearch guifg=#ebebeb guibg=#394759 guisp=NONE gui=bold,reverse cterm=bold,reverse
    hi LineNr guifg=#ebebeb guibg=#394759 guisp=NONE gui=NONE cterm=NONE
    hi MatchParen guifg=#ff3100 guibg=#394759 guisp=NONE gui=NONE cterm=NONE
    ...
    hi SpellBad guifg=#ebebeb guibg=#394759 guisp=#ff3100 gui=NONE cterm=NONE
    hi SpellCap guifg=#ebebeb guibg=#394759 guisp=#ff3100 gui=NONE cterm=NONE
    hi SpellLocal guifg=#ebebeb guibg=#394759 guisp=#ff3100 gui=NONE cterm=NONE
    hi SpellRare guifg=#ebebeb guibg=#394759 guisp=#ff3100 gui=reverse cterm=reverse
    ...
    hi Visual guifg=#ebebeb guibg=#394759 guisp=NONE gui=reverse cterm=reverse
  ...
  if get(g:, 'rams_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#53585f guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Terminal guifg=#53585f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
  ...
  hi ColorColumn guifg=fg guibg=#53585f guisp=NONE gui=NONE cterm=NONE
  hi Conceal guifg=NONE guibg=NONE guisp=NONE gui=NONE ctermfg=NONE ctermbg=NONE cterm=NONE
  ...
  hi MatchParen guifg=#ff3100 guibg=#ebebeb guisp=NONE gui=reverse cterm=reverse
  ...
  hi Search guifg=#53585f guibg=#ebebeb guisp=NONE gui=NONE cterm=NONE
  ...
  hi SpellBad guifg=#53585f guibg=#ebebeb guisp=#ff3100 gui=NONE cterm=NONE
  hi SpellCap guifg=#53585f guibg=#ebebeb guisp=#ff3100 gui=NONE cterm=NONE
  hi SpellLocal guifg=#53585f guibg=#ebebeb guisp=#ff3100 gui=NONE cterm=NONE
  hi SpellRare guifg=#53585f guibg=#ebebeb guisp=#ff3100 gui=reverse cterm=reverse
  ...
  hi Identifier guifg=#53585f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi Statement guifg=#53585f guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#53585f guibg=NONE guisp=NONE gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi IncSearch ctermfg=255 ctermbg=238 cterm=bold,reverse
    hi LineNr ctermfg=255 ctermbg=238 cterm=NONE
    hi MatchParen ctermfg=196 ctermbg=238 cterm=NONE
    ...
    hi Visual ctermfg=255 ctermbg=238 cterm=reverse
  ...
  hi MatchParen ctermfg=196 ctermbg=255 cterm=reverse
...
if s:t_Co >= 8
  if &background ==# 'dark'
    ...
    hi IncSearch ctermfg=LightGrey ctermbg=Black cterm=bold,reverse
    hi LineNr ctermfg=LightGrey ctermbg=Black cterm=NONE
    hi MatchParen ctermfg=DarkRed ctermbg=Black cterm=NONE
    ...
    hi Visual ctermfg=LightGrey ctermbg=Black cterm=reverse
  ...
  hi IncSearch ctermfg=Black ctermbg=LightGrey cterm=bold,reverse
  hi LineNr ctermfg=Black ctermbg=LightGrey cterm=NONE
  hi MatchParen ctermfg=DarkRed ctermbg=LightGrey cterm=reverse
...
" Color: red                  rgb(255,  49,   0)     ~        DarkRed
" Color: white                rgb(235, 235, 235)     ~        LightGrey
" Term colors: black red red red red red red white
" Term colors: black red red red red red red white
" Background: light
