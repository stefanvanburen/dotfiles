...
do
  ...
  conform.setup({formatters_by_ft = {fennel = {"fnlfmt"}, fish = {"fish_indent"}, go = {lsp_format = "fallback"}, just = {"just"}, proto = {"buf"}}, format_on_save = {timeout_ms = 5000}})
end
