...
local function _12_()
  ...
  return null_ls.setup({sources = {null_ls.builtins.diagnostics.buf, null_ls.builtins.formatting.buf, null_ls.builtins.diagnostics.fish, null_ls.builtins.formatting.fish_indent, null_ls.builtins.formatting.prettier, null_ls.builtins.formatting.shfmt}, debug = false})
end
local function _13_()
...
local function _15_()
  ...
  vim.keymap.set("n", "<leader>ed", _16_)
  local function _17_()
    return fzf_lua.files({cwd = "~/.config/nvim"})
  end
  return vim.keymap.set("n", "<leader>ev", _17_)
end
local function _18_()
...
lazy.setup({{url = "https://github.com/zbirenbaum/copilot.lua", config = _1_, enabled = false}, {url = "https://github.com/tyru/open-browser.vim"}, {url = "https://github.com/lewis6991/fileline.nvim"}, {url = "https://github.com/lewis6991/gitsigns.nvim", config = _2_}, {url = "https://github.com/tpope/vim-fugitive", config = _8_}, {url = "https://github.com/tpope/vim-rhubarb"}, {url = "https://github.com/mattn/vim-gotmpl"}, {url = "https://github.com/fladson/vim-kitty"}, {url = "https://github.com/janet-lang/janet.vim"}, {url = "https://github.com/Olical/nfnl", config = true, ft = "fennel"}, {url = "https://github.com/Olical/conjure", config = _9_}, {url = "https://github.com/gpanders/nvim-parinfer"}, {url = "https://github.com/vim-test/vim-test", dependencies = {{url = "https://github.com/tpope/vim-dispatch"}}, config = _10_}, {url = "https://github.com/nvim-lua/plenary.nvim"}, {url = "https://github.com/neovim/nvim-lspconfig"}, {url = "https://github.com/b0o/SchemaStore.nvim"}, {url = "https://github.com/williamboman/mason.nvim", config = true}, {url = "https://github.com/williamboman/mason-lspconfig.nvim", config = true}, {url = "https://github.com/nvim-treesitter/nvim-treesitter", build = ":TSUpdate", config = _11_}, {url = "https://github.com/jose-elias-alvarez/null-ls.nvim", config = _12_}, {url = "https://github.com/echasnovski/mini.nvim", config = _13_}, {url = "https://github.com/ibhagwan/fzf-lua", config = _15_}, {url = "https://github.com/tpope/vim-eunuch"}, {url = "https://github.com/andymass/vim-matchup", config = _18_}, {url = "https://github.com/ggandor/leap.nvim", dependencies = {{url = "https://github.com/tpope/vim-repeat"}}, config = _19_}, {url = "https://github.com/tpope/vim-abolish"}, {url = "https://github.com/tpope/vim-repeat"}, {url = "https://github.com/rktjmp/lush.nvim"}, {url = "https://git.sr.ht/~p00f/alabaster.nvim", priority = 1000, config = _20_, enabled = false, lazy = false}, {url = "https://github.com/stefanvanburen/rams", priority = 1000, config = _21_, enabled = false, lazy = false}, {url = "https://github.com/mcchrish/zenbones.nvim", priority = 1000, config = _22_, enabled = false, lazy = false}, {url = "https://github.com/rose-pine/neovim", name = "rose-pine", enabled = true, priority = 1000, config = _23_, lazy = false}}, {install = {colorscheme = {"randomhue", "zenwritten", "rams", "alabaster", "rose-pine"}}})
...
create_autocmd("TextYankPost", {callback = _24_})
...
do
  ...
  for filetype, settings in pairs(filetype_settings) do
    ...
    create_autocmd("FileType", {group = aufiletypes, pattern = filetype, callback = _25_})
  end
  local function _26_()
    return vim.api.nvim_set_option_value("filetype", "make", {scope = "local"})
  end
  create_autocmd({"BufNewFile", "BufRead"}, {group = aufiletypes, pattern = "justfile", callback = _26_})
  local function _27_()
  ...
  create_autocmd("FileType", {group = aufiletypes, pattern = "fennel", callback = _29_})
end
...
local function on_attach(_47_)
  ...
  if client.server_capabilities.documentFormattingProvider then
    ...
    buffer_map("<leader>af", _50_)
    if ((client.name ~= "tsserver") and (client.name ~= "null-ls")) then
      local function _51_()
        return format(client)
      end
