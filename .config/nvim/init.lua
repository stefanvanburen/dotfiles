    ...
    local function _22_()
      for name, value in pairs(settings) do
        if (name == "compiler") then
          vim.cmd({cmd = "compiler", args = {value}})
        else
