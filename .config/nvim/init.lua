...
local function _4_()
  ...
  return gitsigns.setup({on_attach = _5_, attach_to_untracked = false})
end
local function _10_()
...
local function _13_()
  ...
  return vim.api.nvim_create_autocmd("BufWritePost", {callback = _14_})
end
local function _15_()
...
local function _16_()
  ...
  vim.keymap.set("n", "<leader>fg", _17_)
...
lazy.setup({{url = "https://github.com/justinmk/vim-dirvish"}, {url = "https://github.com/justinmk/vim-gtfo", config = _2_}, {url = "https://github.com/zbirenbaum/copilot.lua", config = _3_, enabled = false}, {url = "https://github.com/tyru/open-browser.vim"}, {url = "https://github.com/lewis6991/fileline.nvim"}, {url = "https://github.com/lewis6991/gitsigns.nvim", config = _4_}, {url = "https://github.com/tpope/vim-fugitive", config = _10_}, {url = "https://github.com/tpope/vim-rhubarb"}, {url = "https://github.com/mattn/vim-gotmpl"}, {url = "https://github.com/fladson/vim-kitty"}, {url = "https://github.com/NoahTheDuke/vim-just"}, {url = "https://github.com/jaawerth/fennel.vim"}, {url = "https://github.com/janet-lang/janet.vim"}, {url = "https://github.com/Olical/nfnl"}, {url = "https://github.com/Olical/conjure", config = _11_}, {url = "https://github.com/gpanders/nvim-parinfer"}, {url = "https://github.com/vim-test/vim-test", dependencies = {{url = "https://github.com/tpope/vim-dispatch"}}, config = _12_}, {url = "https://github.com/neovim/nvim-lspconfig"}, {url = "https://github.com/mfussenegger/nvim-lsp-compl"}, {url = "https://github.com/b0o/SchemaStore.nvim"}, {url = "https://github.com/stevearc/conform.nvim", opts = {formatters_by_ft = {proto = {"buf"}}, format_on_save = {timeout_ms = 500, lsp_fallback = true}}}, {url = "https://github.com/mfussenegger/nvim-lint", config = _13_}, {url = "https://github.com/williamboman/mason.nvim", config = true, build = ":MasonUpdate"}, {url = "https://github.com/williamboman/mason-lspconfig.nvim", config = true}, {url = "https://github.com/nvim-treesitter/nvim-treesitter", build = ":TSUpdate", config = _15_}, {url = "https://github.com/echasnovski/mini.nvim", config = _16_}, {url = "https://github.com/mfussenegger/nvim-overfly", dependencies = {{url = "https://github.com/mfussenegger/nvim-qwahl"}}}, {url = "https://github.com/tpope/vim-eunuch"}, {url = "https://github.com/andymass/vim-matchup", config = _18_}, {url = "https://github.com/ggandor/leap.nvim", dependencies = {{url = "https://github.com/tpope/vim-repeat"}}, config = _19_}, {url = "https://github.com/tpope/vim-abolish"}, {url = "https://github.com/tpope/vim-repeat"}, {url = "https://github.com/rktjmp/lush.nvim"}, {url = "https://git.sr.ht/~p00f/alabaster.nvim", lazy = true, priority = 1000, config = _20_}, {url = "https://github.com/stefanvanburen/rams", lazy = true, priority = 1000, config = _21_}, {url = "https://github.com/mcchrish/zenbones.nvim", priority = 1000, config = _22_, lazy = false}, {url = "https://github.com/rose-pine/neovim", name = "rose-pine", lazy = true, priority = 1000, config = _23_}}, {install = {colorscheme = {"randomhue", "zenwritten", "rams", "alabaster", "rose-pine"}}})
vim.api.nvim_create_autocmd("VimResized", {command = ":wincmd ="})
local function _24_()
  return vim.highlight.on_yank()
end
vim.api.nvim_create_autocmd("TextYankPost", {callback = _24_})
...
do
  ...
  for filetype, settings in pairs(filetype_settings) do
    ...
    vim.api.nvim_create_autocmd("FileType", {group = aufiletypes, pattern = filetype, callback = _25_})
  end
  local function _26_()
    return vim.api.nvim_set_option_value("filetype", "markdown", {scope = "local"})
  end
  vim.api.nvim_create_autocmd({"BufNewFile", "BufRead"}, {group = aufiletypes, pattern = "*.mdx", callback = _26_})
  local function _27_()
    return vim.api.nvim_set_option_value("filetype", "starlark", {scope = "local"})
  end
  vim.api.nvim_create_autocmd({"BufNewFile", "BufRead"}, {group = aufiletypes, pattern = "*.star", callback = _27_})
end
...
map("n", "<leader>cl", _42_)
local function _43_()
  return vim.cmd({cmd = "split"})
end
map("n", "<leader>ss", _43_)
local function _44_()
  return vim.cmd({cmd = "vsplit"})
end
map("n", "<leader>vs", _44_)
map("n", "]r", ":tabnext<cr>")
map("n", "[r", ":tabprev<cr>")
...
lspconfig.yamlls.setup({settings = {yaml = {schemas = schemastore.yaml.schemas(), schemaStore = {url = "", enable = false}}}})
